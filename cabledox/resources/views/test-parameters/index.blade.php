...
@section('title', 'List Test Parameters')
    ...
    <div class="row clearfix">          
        <div class="col-xl-12 col-md-12 col-sm-12 text-md-right" style="text-align: right; ">
            @can('test-parameters.create')
                <a href="{{route('test-parameters.create')}}" class="btn btn-primary text-white"><i class="icon-plus"></i> Add New</a>
            @endcan
        </div>
    </div>
</div>
...
<div class="row clearfix"> 
    <div class="col-lg-12">
        <div class="card"> 
            <div class="header">
                <h2>{{ __('List Test Parameters Details') }}</h2>
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-hover test-parameters-datatable">
                        <thead>
                            <tr>
                                <th>S.No</th>
                                <th>Parameters</th>
...
<script type="text/javascript">
    ...
    function drawTable() {
        return $('.test-parameters-datatable').DataTable({   
            processing: true,
            serverSide: true,
