@if(!empty($getTestParameter))
	<div class= "form-group row border">
		...
		<div class="col-md-6 border test-result">
			...
			<div class="col-md-6 border test-result">		           
				<input type="text" name="output[]" class="form-control @error('output') is-invalid @enderror" value="{{$testResultOutput}}" required autocomplete="output"  autofocus placeholder="Please enter output">
			        @error('output')
