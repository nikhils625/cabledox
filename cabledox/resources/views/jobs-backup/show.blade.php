        ...
        <div class="card">  
            ...
            <div class="body">
                ...
                <div class="form-group m-t-10 jobs-test">
                    ...
                    @endif
                    <a href ="{{ route('job.view-final-check-sheet', $job->id) }}" target="_blank"> <button type="button" class="btn btn-outline-info" data-toggle="modal" data-target="#final-check-sheet">{{ __('Fill Final Check Sheet') }}</button> </a>
                    @if($job->status != 2)
