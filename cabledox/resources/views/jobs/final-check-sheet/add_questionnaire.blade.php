    ...
    <table class="table table-bordered table-stripped table-condensed">
        <thead>
            <tr>
                ...
                <td width="20%">
                    Item
                    @if(isset($jobFinalCheckSheet->id))
                        <input type="hidden" name="job_final_check_sheet_id" value="{{$jobFinalCheckSheet->id}}">
                    @endif
                </td>
                ...
                @foreach($questionnaire as $key => $question)
                    ...
                    <tr>
                        ...
                        <td width="20%">
                            ...
                            @if(isset($jobFinalCheckSheet->jobFinalCheckSheetDetails[$key]))
                                <input type="hidden" name="questionnaire[id][]" value="{{$jobFinalCheckSheet->jobFinalCheckSheetDetails[$key]->id}}">
                            @endif
                            <input type="hidden" name="questionnaire[fcs_questionnaire_id][]" value="{{$question->id}}">
                        </td>
                        <td width="40%">
                            <input type="text" name="questionnaire[completed][]" id="completed_{{$key}}" class="form-control @error('completed') is-invalid @enderror" value="{{ $completedValue }}" required autocomplete="completed" autofocus placeholder="Please enter completed (Y, N, N/A)">
                            @error('completed')
                        ...
                        <td width="30%">
                            <textarea name="questionnaire[comment][]" id="comment_{{$key}}" class="form-control @error('comment') is-invalid @enderror textarea" required cols="50" rows="3">{{ $commentValue }}</textarea>
                            @error('comment')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
        ...
        <div class="form-group row">
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="inspector_name" id="inspector_name" class="form-control @error('inspector_name') is-invalid @enderror" value="{{ $inspectorName }}" required autocomplete="inspector_name">
                    ...
                    <div class="col-md-8">
                        ...
                        @endphp
                                <div class="signature-image-div @if(empty($inspectorImageName)) hidden @endif">
                                    ...
                                    <input type="hidden" name="old_inspector_signature" value="{{$inspectorImageName}}">
                                    <span class="fa fa-pencil remove text-danger" data-img_name="inspector_signature" data-init_target="inspectorSigPad"></span>
                                </div>
                        @php
                            }
                        @endphp
                        <div class="sigPad inspectorSigPad signed @if(!empty($inspectorImageName)) hidden @endif">
                            <div class="sig sigWrapper">
                                <div class="typed"></div>
                                <canvas class="pad sign-pad" id="sign-pad" width="220" height="55"></canvas>
                                <input type="hidden" name="inspector_signature" class="output">
                            </div>
                            <ul class="sigNav">
                                <li class="clearButton"><a href="#clear">Clear</a></li>
                            </ul>
                        </div>
                        @error('inspector_signature')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="inspector_signature_date" id="inspector_signature_date" class="form-control @error('inspector_signature_date') is-invalid @enderror" value="{{$inspectorSignatureDate}}" required data-date-format="yyyy/mm/dd" data-provide="datepicker" data-date-today-highlight="true" data-date-autoclose="true" placeholder="Select date" autocomplete="inspector_signature_date">
                        @error('inspector_signature_date')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
        ...
        <div class="form-group row">
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="pc_inspector_name" id="pc_inspector_name" class="form-control @error('pc_inspector_name') is-invalid @enderror" value="{{$pcInspectorName}}" required autocomplete="pc_inspector_name">
                        @error('pc_inspector_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                    ...
                    <div class="col-md-8">
                        ...
                        @endphp
                                <div class="signature-image-div @if(empty($pcInspectorImageName)) hidden @endif">
                                    ...
                                    <input type="hidden" name="old_pc_inspector_signature" value="{{$pcInspectorImageName}}">
                                    <span class="fa fa-pencil remove text-danger" data-img_name="pc_inspector_signature" data-init_target="pcSigPad"></span>
                                </div>
                        @php
                            }
                        @endphp
                        <div class="sigPad pcSigPad signed @if(!empty($pcInspectorImageName)) hidden @endif">
                            <div class="sig sigWrapper">
                                <div class="typed"></div>
                                <canvas class="pad sign-pad" id="sign-pad" width="220" height="55"></canvas>
                                <input type="hidden" name="pc_inspector_signature" class="output">
                            </div>
                            <ul class="sigNav">
                                <li class="clearButton"><a href="#clear">Clear</a></li>
                            </ul>
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="pc_inspector_signature_date" id="pc_inspector_signature_date" class="form-control @error('pc_inspector_signature_date') is-invalid @enderror" value="{{$pcInspectorSignatureDate}}" required data-date-format="yyyy/mm/dd" data-provide="datepicker" data-date-today-highlight="true" data-date-autoclose="true" placeholder="Select date" autocomplete="pc_inspector_signature_date">
                        @error('pc_inspector_signature_date')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
