            ...
            <div class="col-md-6 ">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        @endphp
                        <input type="text" name="checklist[{{$key}}][name]" id="checklist_name-{{$key}}" class="form-control" value="{{$checkListName}}" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        @endphp
                        <input type="text" name="checklist[{{$key}}][date]" id="checklist_date-{{$key}}" class="form-control" value="{{$checkListDate}}" readonly>
                    </div>
                </div>
            </div>
        @endforeach
